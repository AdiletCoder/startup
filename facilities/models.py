...
class FavoriteToVisit(models.Model):
    user = models.ForeignKey(MyUser, on_delete=models.CASCADE, related_name='favourites_to_visit')
    visit = models.ForeignKey(PlaceToVisit, on_delete=models.CASCADE, related_name='favourites_to_visit')
...
class FavoriteToEat(models.Model):
    user = models.ForeignKey(MyUser, on_delete=models.CASCADE, related_name='favourites_to_eat')
    eat = models.ForeignKey(PlaceToEat, on_delete=models.CASCADE, related_name='favourites_to_eat')
    favorite = models.BooleanField(default=False)
...
class FavoriteToStay(models.Model):
    user = models.ForeignKey(MyUser, on_delete=models.CASCADE, related_name='favorites_to_stay')
    stay = models.ForeignKey(PlaceToStay, on_delete=models.CASCADE, related_name='favorites_to_stay')
    favorite = models.BooleanField(default=False)
