...
'''--------Favorites---------'''
class FavoriteToVisitViewSet(mixins.CreateModelMixin, mixins.ListModelMixin, viewsets.GenericViewSet):
    queryset = FavoriteToVisit.objects.all()
    serializer_class = FavoriteToVisitSerializer
    permission_classes = [IsAuthenticated, ]
...
class FavoriteToStayViewSet(mixins.CreateModelMixin, mixins.ListModelMixin, viewsets.GenericViewSet):
    queryset = FavoriteToStay.objects.all()
    serializer_class = FavoriteToStaySerializer
    permission_classes = [IsAuthenticated, ]
...
class FavoriteToEatViewSet(mixins.CreateModelMixin, mixins.ListModelMixin, viewsets.GenericViewSet):
    queryset = FavoriteToEat.objects.all()
    serializer_class = FavoriteToEatSerializer
    permission_classes = [IsAuthenticated, ]
