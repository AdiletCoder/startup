...
router_favorites = DefaultRouter()
router_favorites.register('to_visit', FavoriteToVisitViewSet)
router_favorites.register('to_eat', FavoriteToEatViewSet)
router_favorites.register('to_stay', FavoriteToStayViewSet)
...
urlpatterns = [
    ...
    path('favourite/', include(router_favorites.urls))
